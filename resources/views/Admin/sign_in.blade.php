...
<body>
    ...
    <div class="container mt-5" style="margin-right: -15%">
        <form class="">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="prenom">
                    <br>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input type="password" class="form-control" id="password1" aria-describedby="password1">
                    <br>
            ...
            <button type="submit" class="btn btn-primary mt-4 pt-4">Submit</button>
        </form>
    </div>
    <div>
