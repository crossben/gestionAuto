        ...
        <div class="col-md-12" >
        	...
        	<body>
        		...
        		<tr>
                    ...
                    <a href="{{route('vehicules.edit',$vehicule->id)}}"class="btn btn-default">Editer  </a>
                    ...
                    <button href="{{ url('vehicules/detail') }}" type="submit" class="btn btn-danger">Supprimer </button> 
                </form>
