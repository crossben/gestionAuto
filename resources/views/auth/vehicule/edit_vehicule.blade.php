		  	...
		  	<form action="{{url('vehicules/'.$vehicules->id)}}" method="post" enctype="multipart/form-data">
		  		...
		  		<div class="row form-group">
		  			<div class="=col-md-12">
		  				...
		  				<input type="text" name="carburant" class="form-control" value="{{$vehicules->carburant}}"> <br>
		  			</div>
		  		...
		  		<div class="row form-group">
		  			<div class="=col-md-12">
		  				<label> Type:  </label>
		  				<input type="text" name="type" class="form-control" value="{{$vehicules->type}}"> <br>
		  			</div>
		  		</div>
		  		<div class="row form-group">
		  			<div class="=col-md-12">
		  				<label> Kilométrage: </label>
		  				<input type="text" name="kilometrage" class="form-control" value="{{$vehicules->kilometrage}}"> <br>
		  			</div>
		  			<div class="row form-group">
		  			<div class="=col-md-12">
		  			...
		  			<div class="=col-md-12">
		  				...
		  				<input type="text" name="nombreplaces" class="form-control" value="{{$vehicules->nombreplaces}}"> <br>
		  			</div>

		  			<div class="row form-group">
		  			<div class="=col-md-12">
		  				<label> Puissance:  </label> <br>
		  				<input type="text" name="puissance" class="form-control" value="{{$vehicules->puissance}}"> <br><br>
		  			</div>
