...
@section('content')
    ...
    <div style="color: #92a8d1; margin-left: 330px; ">
        <h1></h1>
    </div>
    <div class="pull-right">
        <a href="{{ route('add_vehicule') }}" class="btn btn-success"> Nouvelle voiture </a> <br><br>
        <div class="row">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <p>...</p>
                            <p>
                                <a href="{{ url('voitures/detail') }}" class="btn btn-info" role="button"
